...
def config__tela():
    ...
    <h4 style='text-align: center; color: #FFFFFF;'>Desenvolvido por Leandro Souza<br>
        <a href="https://www.linkedin.com/in/leandro-souza-bi/" target="_blank" style="text-decoration: none; outline: none; border: none;">
            <img src="https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn">
        </a>
        <a href="https://github.com/lsouzadasilva" target="_blank" style="text-decoration: none; outline: none; border: none;">
